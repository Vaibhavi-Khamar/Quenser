						...
						<table>
							...
							<c:forEach items="${question}" var ="quest" >
								<div class="well well-lg">
									<h5><b>${quest.questionTitle}</b></h5>
									<hr>
									<p>${quest.questionDesc}</p>
									<h6>by</h6>
									<a href = "/project/viewProfile/${quest.user.userId}">
									<p>${quest.user.firstName} ${quest.user.lastName}</p>
									</a>
									<hr>

									<a href="ques/viewQuest/${quest.questionId}">
