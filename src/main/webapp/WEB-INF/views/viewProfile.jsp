		...
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<ul class="nav nav-tabs">
					<li class="list-group-item  list-group-item-success"><a href="#">Question Asked</a></li>
					<li class="list-group-item  list-group-item-success"><a href="/project/answers/${usr.userId}">Questions Answered</a></li>
					<li class="list-group-item  list-group-item-success"><a href="/project/updateProfile">Update Profile</a></li>
				</ul>
				<br/>
                <br/>
				...
				<c:if test="${!empty usr.question }">
					<!-- Change it to questions - independent of user -->
					<table>
						...
						<c:forEach items="${usr.question}" var="quest">
							<div class="well well-lg">
								...
								<p style="color: black">
									by <a href="/project/viewProfile/${usr.userId}">${usr.firstName}
										${usr.lastName}</a>
								</p>
								<hr>

								<a href="/project/ques/viewQuest/${quest.questionId}">
